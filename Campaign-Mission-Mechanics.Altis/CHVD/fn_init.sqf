[] spawn {
	...
	player addAction ["<t color='#75B6FF'>Set View Distance</t>",CHVD_fnc_openDialog,[],-99,false,true];
	player addEventHandler ["Respawn", {player addAction ["<t color='#75B6FF'>Set View Distance</t>",CHVD_fnc_openDialog,[],-99,false,true]}];
